...
The dataset was too large for GitHub but can be found below. The following two datasets from Kaggle were merged and used for this project.

[astrophysical-objects-image-dataset](https://www.kaggle.com/datasets/engeddy/astrophysical-objects-image-dataset)

[sun-and-moon-images](https://www.kaggle.com/datasets/khushipitroda/sun-and-moon-images)
